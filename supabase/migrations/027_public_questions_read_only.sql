...
create policy "Public can read visible answer comments"
...
drop policy if exists "Public can read visible ratings" on public.ratings;
...
grant select on public.questions, public.answers, public.answer_comments, public.ratings to anon, authenticated;
