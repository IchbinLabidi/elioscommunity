...
alter table public.notifications add constraint notifications_type_check check (type in (
  ...
  'live_session_scheduled', 'live_session_created', 'live_session_updated',
  'live_session_postponed', 'live_session_cancelled', 'live_session_deleted',
  'live_session_recording_available', 'live_session_recording_added',
  'live_session_reminder'
));

comment on column public.notifications.dedupe_key is
  'Stable key used to prevent repeated delivery for one product event and recipient.';
