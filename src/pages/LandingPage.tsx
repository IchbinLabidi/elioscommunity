        ...
        <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/register" className="inline-flex items-center gap-2 rounded-lg bg-elios-yellow px-5 py-3 font-bold text-elios-navy">
                Join the community <ArrowRight className="h-5 w-5" />
              </Link>
              <Link to="/questions" className="rounded-lg border border-white/20 px-5 py-3 font-bold text-white hover:bg-white/10">
                Browse questions
              </Link>
            </div>
          </div>
