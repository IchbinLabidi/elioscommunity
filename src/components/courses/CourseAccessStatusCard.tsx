...
export default function CourseAccessStatusCard({
  ...
  const states = {
    ...
    pending: {
      ...
      subtitle: 'Votre preuve de paiement est en cours de verification.',
      badge: <CourseStatusBadge tone="pending" label="En attente" />,
    ...
    approved: {
      icon: CheckCircle2,
      title: 'Cours debloque',
      subtitle: 'Votre inscription est approuvee. Vous pouvez acceder au contenu complet du cours.',
      badge: <CourseStatusBadge tone="purchased" label="Approuvee" />,
      cta: started ? 'Continuer le cours' : 'Commencer le cours',
      action: onStartLearning,
    ...
    rejected: {
      ...
      subtitle: enrollment?.rejection_reason || 'Consultez les informations de paiement puis renvoyez une preuve valide.',
      badge: <CourseStatusBadge tone="rejected" />,
      cta: 'Renvoyer une preuve',
    ...
    cancelled: {
      ...
      subtitle: 'Cette inscription a ete annulee. Vous pouvez en effectuer une nouvelle.',
